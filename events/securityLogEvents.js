...
function logSystemEvent(guild, title, fields, colorHex = '#313338', logType = 'system') {
...
module.exports = [
{
    ...
    async execute(ban, client) {
        ...
        logSystemEvent(ban.guild, 'Uye Yasaklandi (Ban)', fields, '#313338');
    }
},
{
    ...
    async execute(member, client) {
        ...
        data.timeout = setTimeout(async () => {
            ...
            logSystemEvent(member.guild, title, fields, '#313338');
        }, 3000);
    }
},
{
...
},
{
    ...
    async execute(emoji, client) {
        ...
        logSystemEvent(emoji.guild, 'Emoji Guncellendi', fields, '#313338');
    }
},
{
    ...
    async execute(channel, client) {
        ...
        logSystemEvent(channel.guild, 'Webhook Guncellendi', fields, '#313338');
    }
},
{
    ...
    async execute(ban, client) {
        ...
        logSystemEvent(ban.guild, 'Yasaklama (Ban) Kaldirildi', fields, '#313338');
    }
},
{
    ...
    async execute(invite) {
        ...
        logSystemEvent(invite.guild, 'Yeni Davet Baglantisi Olusturuldu', fields, '#313338');
    }
},
{
    ...
    async execute(invite) {
        ...
        logSystemEvent(invite.guild, 'Davet Baglantisi Silindi', fields, '#313338');
    }
},
{
    ...
    async execute(oldChannel, newChannel) {
        ...
        if (oldChannel.name !== newChannel.name) {
            ...
            logSystemEvent(newChannel.guild, 'Kanal Isin Degisikligi', fields, '#313338');
        }
    }
}
];