...
module.exports = [
{
    ...
    async execute(message, client) {
        ...
        logSystemEvent(message.guild, 'Mesaj Silindi', fields, '#FF4444', 'text');
    }
},
{
    ...
    execute(oldMessage, newMessage) {
        ...
        logSystemEvent(oldMessage.guild, 'Mesaj Düzenlendi', fields, '#FFAA00');
    }
},
{
    ...
    async execute(oldMember, newMember, client) {
        ...
        if (oldMember.nickname !== newMember.nickname) {
            ...
            logSystemEvent(newMember.guild, 'İsim (Nickname) Değiştirildi', fields, '#00AAFF');
        }
        ...
        if (oldMember.roles.cache.size !== newMember.roles.cache.size) {
            ...
            if (addedRoles.size > 0 || removedRoles.size > 0) {
                ...
                data.timeout = setTimeout(async () => {
                    ...
                    logSystemEvent(newMember.guild, 'Roller Güncellendi', fields, data.added.size > 0 ? '#00FF00' : '#FF5555');
                }, 2000);
            }
        }
    }
    ...
    async execute(channel) {
        ...
        data.timeout = setTimeout(async () => {
            ...
            if (otherChannels.length > 0) {
                ...
                logSystemEvent(channel.guild, title, fields, '#00FF00');
            }
    ...
    async execute(channel) {
        ...
        data.timeout = setTimeout(async () => {
            ...
            if (otherChannels.length > 0) {
                ...
                logSystemEvent(data.items[0].guild, title, fields, '#FF0000');
            }
...
},
{
    ...
    async execute(role) {
        ...
        data.timeout = setTimeout(async () => {
            ...
            logSystemEvent(role.guild, title, fields, '#00FF00');
        }, 3000);
    }
},
{
    ...
    async execute(role) {
        ...
        data.timeout = setTimeout(async () => {
            ...
            logSystemEvent(role.guild, title, fields, '#FF0000');
        }, 3000);
    }
},
{
    ...
    async execute(oldChannel, newChannel) {
        ...
        if (isVoice) {
            ...
            logSystemEvent(newChannel.guild, 'Kanal Güncellendi', fields, '#00AAFF');
        }
    }
},
{
    ...
    async execute(ban, client) {
        ...
        logSystemEvent(ban.guild, 'Kullanıcı Yasaklandı (Ban)', fields, '#FF0000');
    }
},
{
    ...
    async execute(ban, client) {
        ...
        logSystemEvent(ban.guild, 'Yasaklama (Ban) Kaldırıldı', fields, '#00FF00');
    }
},
{
    ...
    async execute(member, client) {
        ...
        const color = executorId ? '#FF5555' : '#AAAAAA';
...
},
{
    ...
    async execute(invite, context) {
        ...
        logSystemEvent(invite.guild, 'Yeni Davet Bağlantısı Oluşturuldu', fields, '#00FFAA');
    }
},
{
    ...
    async execute(invite, context) {
        ...
        logSystemEvent(invite.guild, 'Davet Bağlantısı Silindi', fields, '#FFAA00');
    }
},
{
    ...
    async execute(oldRole, newRole) {
        ...
        logSystemEvent(newRole.guild, 'Rol Güncellendi', fields, '#FFAA00');
    }
},
{
    ...
    async execute(role) {
        ...
        logSystemEvent(role.guild, 'Yeni Rol Oluşturuldu', fields, '#00FF00');
    }
},
{
    ...
    async execute(role) {
        ...
        logSystemEvent(role.guild, 'Rol Silindi', fields, '#FF0000');
    }
},
{
    ...
    async execute(channel) {
        ...
        logSystemEvent(channel.guild, 'Webhook Güncellemesi', fields, '#FF00FF');
    }
},
{
    ...
    async execute(oldGuild, newGuild) {
        ...
        logSystemEvent(newGuild, 'Sunucu Ayarları Güncellendi', fields, '#00AAFF');
    }
},
{
